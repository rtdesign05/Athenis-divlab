...
const router = createBrowserRouter([
  ...
  // ── Company space ───────────────────────────────────────────────────────────
  {
    ...
    children: [{ path: '/app', lazy: lz(() => import('@/shared/components/layout/AppLayout'), 'AppLayout'), children: [
      ...
      { path: 'invoices',     lazy: lz(() => import('@/pages/app/BillingPage'), 'BillingPage') },
      { path: 'quotes',       lazy: lz(() => import('@/pages/app/QuotesPage'), 'QuotesPage') },
      { path: 'clients',      lazy: lz(() => import('@/pages/app/ClientsPage'), 'ClientsPage') },
      { path: 'expenses',     lazy: lz(() => import('@/pages/app/ExpensesPage'), 'ExpensesPage') },
      { path: 'reports',      lazy: lz(() => import('@/pages/app/Placeholder'), 'Placeholder') },
      { path: 'hr/leaves',   lazy: lz(() => import('@/pages/app/hr/LeavesPage'),   'LeavesPage') },
      { path: 'hr/planning', lazy: lz(() => import('@/pages/app/hr/PlanningPage'), 'PlanningPage') },
      { path: 'hr/reviews',  lazy: lz(() => import('@/pages/app/hr/ReviewsPage'),  'ReviewsPage') },
      { path: 'hr/payslip',  lazy: lz(() => import('@/pages/app/hr/PayslipPage'),  'PayslipPage') },
      { path: 'hr/*',        lazy: lz(() => import('@/pages/app/Placeholder'), 'Placeholder') },
      { path: 'accounting/bank',    lazy: lz(() => import('@/pages/app/accounting/BankPage'),    'BankPage') },
      { path: 'accounting/vat',     lazy: lz(() => import('@/pages/app/accounting/TVAPage'),     'TVAPage') },
      { path: 'accounting/fec',     lazy: lz(() => import('@/pages/app/accounting/FECPage'),     'FECPage') },
      { path: 'accounting/cloture', lazy: lz(() => import('@/pages/app/accounting/CloturePage'), 'CloturePage') },
      { path: 'accounting/*',       lazy: lz(() => import('@/pages/app/Placeholder'),            'Placeholder') },
      { path: 'legal/contracts', lazy: lz(() => import('@/pages/app/legal/ContractsPage'), 'ContractsPage') },
      { path: 'legal/gdpr',      lazy: lz(() => import('@/pages/app/legal/GdprPage'),      'GdprPage') },
      { path: 'legal/alerts',    lazy: lz(() => import('@/pages/app/legal/AlertsPage'),    'AlertsPage') },
      { path: 'legal/*',         lazy: lz(() => import('@/pages/app/Placeholder'), 'Placeholder') },
      { path: 'esg',           lazy: lz(() => import('@/pages/app/esg/EsgDashboard'),  'EsgDashboard') },
      { path: 'esg/scope',     lazy: lz(() => import('@/pages/app/esg/ScopePage'),     'ScopePage') },
      { path: 'esg/benchmark', lazy: lz(() => import('@/pages/app/esg/BenchmarkPage'), 'BenchmarkPage') },
      { path: 'esg/csrd',      lazy: lz(() => import('@/pages/app/esg/CsrdPage'),      'CsrdPage') },
      { path: 'esg/actions',   lazy: lz(() => import('@/pages/app/esg/ActionPlanPage'),'ActionPlanPage') },
