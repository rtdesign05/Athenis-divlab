...
export async function updateAsset(companyId: string, id: string, input: Partial<AssetInput>) {
  ...
  return prisma.asset.update({
    where: { id },
    data: {
      ...(input.designation      !== undefined && input.designation      !== null ? { designation:      input.designation }                                                    : {}),
      ...
      ...(input.acquisitionDate  !== undefined && input.acquisitionDate  !== null ? { acquisitionDate:  new Date(input.acquisitionDate) }                                     : {}),
      ...(input.grossValue       !== undefined && input.grossValue       !== null ? { grossValue:       input.grossValue }                                                    : {}),
      ...(input.residualValue    !== undefined && input.residualValue    !== null ? { residualValue:    input.residualValue }                                                 : {}),
      ...(input.depreciationMode !== undefined && input.depreciationMode !== null ? { depreciationMode: input.depreciationMode }                                              : {}),
